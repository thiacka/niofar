...
const translations: Translations = {
  ...
  'admin.usersManagement': { en: 'Users Management', fr: 'Gestion des utilisateurs' },
  'admin.addUser': { en: 'Add User', fr: 'Ajouter un utilisateur' },
  'admin.editUser': { en: 'Edit User', fr: 'Modifier l\'utilisateur' },
  'admin.noUsers': { en: 'No users yet', fr: 'Aucun utilisateur pour le moment' },
  'admin.name': { en: 'Name', fr: 'Nom' },
  'admin.email': { en: 'Email', fr: 'Email' },
  'admin.role': { en: 'Role', fr: 'Role' },
  'admin.lastLogin': { en: 'Last Login', fr: 'Derniere connexion' },
  'admin.activeAccount': { en: 'Active account', fr: 'Compte actif' },
  'admin.confirmDeleteUser': { en: 'Are you sure you want to delete this user?', fr: 'Etes-vous sur de vouloir supprimer cet utilisateur ?' },
  'admin.leaveEmptyToKeep': { en: 'leave empty to keep current', fr: 'laisser vide pour conserver l\'actuel' },
  'admin.permissions': { en: 'Permissions', fr: 'Permissions' },
  'admin.roleAdministrator': { en: 'Administrator', fr: 'Administrateur' },
  'admin.roleEditor': { en: 'Editor', fr: 'Editeur' },
  'admin.roleContributor': { en: 'Contributor', fr: 'Contributeur' },
  'admin.permissionAll': { en: 'Full access to all features', fr: 'Acces complet a toutes les fonctionnalites' },
  'admin.permissionEditCircuits': { en: 'Edit circuits', fr: 'Modifier les circuits' },
  'admin.permissionEditPromotions': { en: 'Edit promotions', fr: 'Modifier les promotions' },
  'admin.permissionEditImages': { en: 'Edit images', fr: 'Modifier les images' },
  'admin.permissionViewBookings': { en: 'View bookings', fr: 'Voir les reservations' },
  'admin.permissionViewMessages': { en: 'View messages', fr: 'Voir les messages' },
  'admin.permissionViewCircuits': { en: 'View circuits', fr: 'Voir les circuits' },
