...
const translations: Translations = {
  ...
  'booking.promotionCode': { en: 'Promotion Code (optional)', fr: 'Code promo (optionnel)' },
  'booking.promotionCodePlaceholder': { en: 'Enter your promo code', fr: 'Entrez votre code promo' },
  'booking.promoApplied': { en: 'Promo code applied', fr: 'Code promo applique' },
  'booking.promoInvalid': { en: 'Invalid or expired promo code', fr: 'Code promo invalide ou expire' },
  ...
  'bookingLookup.title': { en: 'Track Your Booking', fr: 'Suivre votre reservation' },
  'bookingLookup.subtitle': { en: 'Enter your booking reference to view details', fr: 'Entrez votre reference de reservation pour voir les details' },
  'bookingLookup.referenceNumber': { en: 'Booking Reference Number', fr: 'Numero de reference de reservation' },
  'bookingLookup.referencePlaceholder': { en: 'NF-YYYYMMDD-XXXX', fr: 'NF-AAAAMMJJ-XXXX' },
  'bookingLookup.referenceHelp': { en: 'You received this reference in your confirmation email', fr: 'Vous avez recu cette reference dans votre email de confirmation' },
  'bookingLookup.search': { en: 'Find My Booking', fr: 'Trouver ma reservation' },
  'bookingLookup.notFound': { en: 'No booking found with this reference number', fr: 'Aucune reservation trouvee avec ce numero de reference' },
  'bookingLookup.error': { en: 'An error occurred. Please try again.', fr: 'Une erreur s\'est produite. Veuillez reessayer.' },
  'bookingLookup.bookingDetails': { en: 'Booking Details', fr: 'Details de la reservation' },
  'bookingLookup.circuitInfo': { en: 'Circuit Information', fr: 'Informations sur le circuit' },
  'bookingLookup.circuit': { en: 'Circuit', fr: 'Circuit' },
  'bookingLookup.startDate': { en: 'Start Date', fr: 'Date de debut' },
  'bookingLookup.endDate': { en: 'End Date', fr: 'Date de fin' },
  'bookingLookup.travelers': { en: 'Travelers', fr: 'Voyageurs' },
  'bookingLookup.personalInfo': { en: 'Personal Information', fr: 'Informations personnelles' },
  'bookingLookup.name': { en: 'Name', fr: 'Nom' },
  'bookingLookup.bookingInfo': { en: 'Booking Information', fr: 'Informations de reservation' },
  'bookingLookup.bookingDate': { en: 'Booking Date', fr: 'Date de reservation' },
  'bookingLookup.status': { en: 'Status', fr: 'Statut' },
  'bookingLookup.searchAnother': { en: 'Search Another Booking', fr: 'Rechercher une autre reservation' },
  'bookingLookup.contactUs': { en: 'Contact Us', fr: 'Nous contacter' },
  ...
  'admin.confirmDeleteBooking': { en: 'Are you sure you want to delete this booking?', fr: 'Etes-vous sur de vouloir supprimer cette reservation ?' },
