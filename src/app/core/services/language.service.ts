...
const translations: Translations = {
  ...
  'rentals.title': { en: 'Vehicle Rental & Incentives', fr: 'Location de Vehicules & Incentives' },
  'rentals.subtitle': { en: 'Explore Senegal at your own pace with our rental services', fr: 'Explorez le Senegal a votre rythme avec nos services de location' },
  'rentals.intro': { en: 'Whether you need a comfortable vehicle for your stay, organizing a corporate incentive, or planning a cruise on the Saloum Delta, we have the perfect solution for you.', fr: 'Que vous ayez besoin d\'un vehicule confortable pour votre sejour, d\'organiser un incentive d\'entreprise, ou de planifier une croisiere sur le Delta du Saloum, nous avons la solution parfaite pour vous.' },
  'rentals.vehicles.title': { en: 'Vehicle Fleet', fr: 'Parc Automobile' },
  'rentals.vehicles.description': { en: 'Quality vehicles with professional drivers for all your travel needs', fr: 'Vehicules de qualite avec chauffeurs professionnels pour tous vos besoins de deplacement' },
  'rentals.incentives.title': { en: 'Corporate Incentives', fr: 'Incentives Entreprises' },
  'rentals.incentives.description': { en: 'Unique team-building experiences and corporate events in Senegal', fr: 'Experiences de team-building uniques et evenements d\'entreprise au Senegal' },
  'rentals.boats.title': { en: 'Cruises & Boats', fr: 'Croisieres & Bateaux' },
  'rentals.boats.description': { en: 'Discover the Saloum Delta and coastal waters aboard our boats', fr: 'Decouvrez le Delta du Saloum et les eaux cotieres a bord de nos bateaux' },
