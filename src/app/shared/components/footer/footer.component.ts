    ...
    <footer class="footer">
      <div class="container">
        <div class="footer-grid">
          <div class="footer-brand">
            <div class="footer-logo">
              ...
              <span class="logo-tagline">Tourisme</span>
            </div>
            <p class="footer-tagline">{{ lang.t('footer.tagline') }}</p>
            <p class="footer-meaning">"We are together" - Wolof</p>
            <div class="social-links">
              <a href="https://wa.me/221756518350?text=Bonjour%20NIO%20FAR%20!%20Je%20suis%20int%C3%A9ress%C3%A9%20par%20vos%20services." target="_blank" rel="noopener noreferrer" class="social-link whatsapp" aria-label="WhatsApp">
          ...
          <div class="footer-contact">
            <h4>Contact</h4>
            <a href="tel:+221756518350" class="contact-item">
              <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                <path d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07 19.5 19.5 0 0 1-6-6 19.79 19.79 0 0 1-3.07-8.67A2 2 0 0 1 4.11 2h3a2 2 0 0 1 2 1.72 12.84 12.84 0 0 0 .7 2.81 2 2 0 0 1-.45 2.11L8.09 9.91a16 16 0 0 0 6 6l1.27-1.27a2 2 0 0 1 2.11-.45 12.84 12.84 0 0 0 2.81.7A2 2 0 0 1 22 16.92z"/>
              </svg>
              <span>+221 75 651 83 50</span>
            </a>
            <a href="mailto:contact@niofartourisme.com" class="contact-item">
              <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                <path d="M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z"/>
                <polyline points="22,6 12,13 2,6"/>
              </svg>
              <span>contact&#64;niofartourisme.com</span>
            </a>
            <div class="contact-item">
              ...
              <span>Saly Portudal, M'bour, Senegal</span>
            </div>
            <a href="https://wa.me/221756518350?text=Bonjour%20NIO%20FAR%20!%20Je%20suis%20int%C3%A9ress%C3%A9%20par%20vos%20services." target="_blank" rel="noopener noreferrer" class="whatsapp-cta">
        ...
        <div class="footer-bottom">
          <p>&copy; {{ currentYear }} NIO FAR TOURISME. {{ lang.t('footer.rights') }}.</p>
        </div>
      </div>
    </footer>
  `,
