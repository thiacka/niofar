...
@Component({
  ...
  template: `
    ...
    <section class="about-intro section">
      <div class="container">
        <div class="about-grid">
          <div class="about-image" appScrollAnimate animationType="fade-left">
          ...
          <div class="about-text" appScrollAnimate animationType="fade-right" [animationDelay]="200">
    ...
    <section class="values section" style="background: var(--color-background-alt);">
      <div class="container">
        ...
        <div class="values-grid">
          <div class="value-item" appScrollAnimate [animationDelay]="0">
          ...
          <div class="value-item" appScrollAnimate [animationDelay]="100">
            <div class="value-icon">
              <svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round">
          ...
          <div class="value-item" appScrollAnimate [animationDelay]="200">
            <div class="value-icon">
              <svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round">
          ...
          <div class="value-item" appScrollAnimate [animationDelay]="300">
            <div class="value-icon">
              <svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round">
    ...
    <section class="closing section">
      <div class="container">
        <div class="closing-content" appScrollAnimate animationType="fade-in">
          <blockquote>
